...
nohup python -u ./train/train.py \
    ...
    --rerank_save_path /data/fkj2023/Project/eccnlp_local/phrase_rerank/data/data_model/model_v0_parameter_bak.pkl \
    >>./log/$(date +%Y%m%d)_2.2_uni_train_uie_res_epo_50.log 2>&1 &
    # >/dev/null 2>&1 &
